...
export default function QuickOnboardingPage() {
  ...
  const handleComplete = async () => {
    try {
      ...
      console.error('Quick onboarding submission error:', error);
      ...
      const errorMessage = error?.message || error?.data?.message || error?.data?.error || 'Failed to complete quick onboarding';
